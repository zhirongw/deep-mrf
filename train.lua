...
-- Data input settings
cmd:option('-train_path','../../pixel/SR/train_ycb4.mat','path to the training data')
cmd:option('-val_path','../../pixel/SR/val_ycb4.mat','path to the val data')
cmd:option('-color', 0, 'whether the input image is color image or grayscale image')
